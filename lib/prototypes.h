...
void std_timestep(struct All_variables *);
void PG_timestep_solve(struct All_variables *);
void isotope_input(struct All_variables *);
...
void get_ba(struct Shape_function *,
            struct Shape_function_dx *,
            struct CC *,
            struct CCX *,
            double [4][9],
            int,
            double [9][9][4][7]);
void get_ba_p(struct Shape_function *,
              struct Shape_function_dx *,
              struct CC *,
              struct CCX *,
              double [4][9],
...
void read_core_liquidus(struct All_variables *);
void update_cmb_T(struct All_variables *);
...
void exchange_vertical_node_f(struct All_variables *, float **, int);
...
/* Mush_related */
void mush_input(struct All_variables *);
...
void output_heatflux(struct All_variables *);
#ifdef USE_GZDIR
/* Output_gzdir.c */
...
void get_global_1d_shape_fn(struct All_variables *,
                            int,
                            struct Shape_function1 *,
                            struct Shape_function1_dA *,
                            int,
                            int);
void get_global_1d_shape_fn_L(struct All_variables *,
                              int,
                              struct Shape_function1 *,
                              struct Shape_function1_dA *,
                              int,
                              int);
void get_global_side_1d_shape_fn(struct All_variables *,
                                 int,
                                 struct Shape_function1 *,
...
void output_S_H(struct All_variables *);
/* Sphere_util.c */
...
void allocate_STD_mem(struct All_variables *, float **, float **, float **, float **,
                      float **, float **, float **, float **);
void free_STD_mem(struct All_variables *, float **, float **, float **, float **,
                  float **, float **, float **, float **);
void compute_nodal_stress(struct All_variables *, float **, float **, float **, float **,
                          float **, float **, float **, float **);
